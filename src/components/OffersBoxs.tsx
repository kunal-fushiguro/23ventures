...
const OffersBoxs = () => {
  return (
    <div className="relative w-full min-h-screen overflow-hidden flex justify-center items-center flex-col gap-4">
      <span className="min-h-[20vh] md:text-6xl font-bold text-3xl w-full h-[20%] text-center flex justify-center items-center">
        We offer 2 seasons
      </span>
      <div className="flex justify-center items-center gap-8 px-2 w-full min-h-[80vh]">
  ...
  return (
    <>
      ...
      >
        <motion.div
          style={{ height }}
          className="w-full max-w-xl boxesbg rounded-[32px] p-8 md:p-12 flex flex-col origin-top"
        >
          {/* Title Section */}
          <div className="text-center mb-12">
            <h2 className="text-5xl md:text-7xl font-medium text-gray-200 mb-4">
              {title}
            </h2>
